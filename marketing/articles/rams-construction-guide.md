---
title: "What Is a RAMS? The Complete Guide to Risk Assessment Method Statements (with Free Template)"
slug: "what-is-a-rams-construction-guide"
description: "A RAMS (Risk Assessment and Method Statement) is a combined health and safety document that sets out the risks of a task and the safe method for carrying it out. This guide covers what a RAMS must include, real examples, and a free template you can adapt with AI."
difficulty: "beginner"
reading_time_minutes: 12
featured: true
sort_order: 1
meta_title: "What Is a RAMS? Complete Guide + Free Template (2026)"
meta_description: "What is a RAMS in construction? A full guide to Risk Assessment Method Statements: what to include, RAMS vs method statement, real examples, and a free editable template."
---
...
That level of detail is what a principal contractor wants to see. Notice that several hazards point to other documents (the COSHH assessment, the permit to work). A RAMS sits at the centre of a small family of safety paperwork. Our [COSHH risk assessment workflow](/ai-workflows/generate-coshh-risk-assessment) covers the substances side in detail.
...
2. **Generate the first draft.** The AI produces the scope, the hazard list with likelihood and severity scores, the control measures, and the method sequence.
3. **Review against reality.** This is the critical step. Check every hazard against the actual site. Add anything the AI missed (site-specific access, adjacent trades, local restrictions). Remove anything that does not apply. Correct any scoring.
4. **Add the human-only sections.** Competence records, named operatives, emergency arrangements specific to that site.
5. **Brief and sign.** Brief the team and record it.
...
Our [draft method statement workflow](/ai-workflows/draft-method-statement) walks through the exact prompt to use, and the full library of construction prompts is in the [BuildCopilot Prompt Pack](/prompt-pack).
