...
export default async function NewGuidePage() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-bold text-slate-900">New Guide</h1>
      <div className="rounded-lg border border-slate-200 bg-white p-6">
        <form action={createGuide} className="space-y-6">
          <div>
          ...
          <div>
            ...
            <textarea id="content" name="content" rows={12} className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
          </div>

          <div className="grid gap-6 sm:grid-cols-2">
            <div>
              <label htmlFor="difficulty" className="mb-1 block text-sm font-medium text-slate-700">Difficulty</label>
              <select id="difficulty" name="difficulty" defaultValue="beginner" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
            ...
            <div>
              ...
              <input id="reading_time_minutes" name="reading_time_minutes" type="number" min="1" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" />
            </div>
